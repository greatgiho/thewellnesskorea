...
export const SESSION_SELECT =
  "id, floor_id, instructor_id, person_program_id, title, path_keys, starts_at, ends_at, capacity, booked_count, is_published, image_paths, description_blocks, created_at, updated_at"
