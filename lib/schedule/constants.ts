...
export const SESSION_SELECT =
  "id, experience_id, floor_id, is_all_floors, instructor_id, partner_program_id, title, path_keys, starts_at, ends_at, capacity, booked_count, price_currency, price_amount, discount_type, discount_value, is_published, status, slot_lane, confirmed_at, confirmed_by, created_by, created_by_email, cancelled_at, cancelled_by, cancel_reason, image_paths, description_blocks, created_at, updated_at"
