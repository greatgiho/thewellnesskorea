 ...
 * second beverage is one more object below; when there are enough of them that
 ...
 * spread on withdrawal. The fixed $0.30 is what makes a single beverage
 * expensive to process — it alone is 6% of this — so the margin here is
 * thinner than the headline rate suggests.
 */
export const BEVERAGES: Beverage[] = [
  { id: "beverage", name: "Beverage", price: { currency: "USD", amount: 5 } },
]

/** What the counter rings up when nothing else is chosen. */
export const DEFAULT_BEVERAGE_ID = "beverage"
