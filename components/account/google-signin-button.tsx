...
/**
 * "Continue with Google" for member sign-in / sign-up. Redirects through
 * /auth/callback with flow=member so the callback marks first-time OAuth users
 * as members (see completeMemberOnboarding treatAsMember).
 */
